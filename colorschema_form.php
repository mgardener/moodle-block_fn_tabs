...
class colorschema_form extends moodleform {
    public function definition() {
        ...
        $mform = $this->_form;
        $mform->addElement('header', '', get_string('colorschema', 'format_ned_tabs'), '');

        $mform->addElement('html', '<table style="width:100%"><tr><td>');

        MoodleQuickForm::registerElementType('tccolourpopup',
            "$CFG->dirroot/course/format/ned_tabs/js/tc_colourpopup.php", 'MoodleQuickForm_tccolourpopup');

        $mform->addElement('text', 'name', get_string('name', 'format_ned_tabs'));
        $mform->setType('name', PARAM_RAW);
        $mform->addRule('name', null, 'required', null, 'client');

        $mform->addElement('tccolourpopup', 'bgcolour',
            get_string('bgcolour', 'format_ned_tabs'), 'maxlength="6" size="6"');
        ...
        $mform->addElement('tccolourpopup', 'activecolour',
            get_string('activeweek', 'format_ned_tabs'), 'maxlength="6" size="6"');
        ...
        $mform->addElement('tccolourpopup', 'selectedcolour',
            get_string('selectedweek', 'format_ned_tabs'), 'maxlength="6" size="6"');
        ...
        $mform->addElement('tccolourpopup', 'inactivecolour',
            get_string('inactiveweek', 'format_ned_tabs'), 'maxlength="6" size="6"');
        ...
        $mform->addElement('tccolourpopup', 'inactivebgcolour',
            get_string('inactivebgcolour', 'format_ned_tabs'), 'maxlength="6" size="6"');
        ...
        $mform->addElement('tccolourpopup', 'activelinkcolour',
            get_string('activelinkcolour', 'format_ned_tabs'), 'maxlength="6" size="6"');
        ...
        $mform->addElement('tccolourpopup', 'selectedlinkcolour',
            get_string('selectedlinkcolour', 'format_ned_tabs'), 'maxlength="6" size="6"');
        ...
        $mform->addElement('tccolourpopup', 'inactivelinkcolour',
            get_string('inactivelinkcolour', 'format_ned_tabs'), 'maxlength="6" size="6"');
        ...
        $mform->addElement('html', '<img src="pix/ned_tabs_colourkey.png" />');
        ...
        $this->add_action_buttons(true, get_string('submit', 'format_ned_tabs'));
    }
